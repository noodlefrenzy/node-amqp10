 ...
 * @constructor
 */
function Connection(connectPolicy, transportDict) {
  ...
  this._transportDict = transportDict;
...
Connection.prototype._connect = function(address, sasl) {
  ...
  self._transport = self._transportDict[address.protocol];
