...
var Connection = function () {
    ...
    this.connSM = StateMachine.machine({
        ...
        'HDR_EXCH': {
            ...
            openReceived: function() { return this.OPEN_RCVD; },
            error: function(err) { self._processError(err); return this.DISCONNECTED; },
            terminated: function() { self._terminate(); return this.DISCONNECTED; }
        },
        'OPEN_RCVD': {
            ...
            invalidOpen: function() {
                self._sendCloseFrame(constants.errors.invalidOpen);
                // Violates state diagram by transitioning past OPENED.
    ...
    this.connSM.onCLOSE_RCVD = function() {
        self._sendCloseFrame();
        self._terminate();
        self.connSM.disconnect();
    };
};
...
Connection.prototype._receiveOpenFrame = function() {
    if (this.connSM.getMachineState() === 'HDR_EXCH') {
        this.connSM.openReceived();
    }
    
    this.connSM.invalidOpen();
};
