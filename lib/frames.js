...
frames.OpenFrame = defineFrame(FrameType.AMQP, {
  ...
  fields: [
    ...
    { name: 'idleTimeOut', type: 'uint', default: constants.defaultIdleTimeout },
    { name: 'outgoingLocales', type: 'symbol', multiple: true, default: constants.defaultOutgoingLocales },
    { name: 'incomingLocales', type: 'symbol', multiple: true, default: constants.defaultIncomingLocales },
...
frames.BeginFrame = defineFrame(FrameType.AMQP, {
  ...
  fields: [
    ...
    { name: 'handleMax', type: 'uint', default: constants.defaultHandleMax },
    { name: 'offeredCapabilities', type: 'symbol', multiple: true },
    { name: 'desiredCapabilities', type: 'symbol', multiple: true },
    { name: 'properties', type: 'fields', default: {} }
  ]
...
frames.AttachFrame = defineFrame(FrameType.AMQP, {
  ...
  fields: [
    ...
    { name: 'sndSettleMode', type: 'ubyte', default: constants.senderSettleMode.mixed },
    { name: 'rcvSettleMode', type: 'ubyte', default: constants.receiverSettleMode.autoSettle },
