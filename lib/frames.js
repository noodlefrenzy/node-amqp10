...
frames.AttachFrame = defineFrame(FrameType.AMQP, {
  ...
  fields: [
    ...
    { name: 'role', type: 'boolean', mandatory: true }, // @spec type: `role` => `boolean` choice
    { name: 'sndSettleMode', type: 'ubyte',
      default: constants.senderSettleMode.mixed },  // @spec type: `sender-settle-mode` => `ubyte` choice
    { name: 'rcvSettleMode', type: 'ubyte',
      default: constants.receiverSettleMode.autoSettle }, // @spec type: `sender-settle-mode` => `ubyte` choice
...
frames.TransferFrame = defineFrame(FrameType.AMQP, {
  ...
  fields:[
    ...
    { name: 'rcvSettleMode', type: 'ubyte', default: 0 }, // @spec type: 'receiver-settle-mode` => `boolean` choice
