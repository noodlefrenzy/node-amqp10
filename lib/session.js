...
Session.prototype._processFrame = function(frame) {
  ...
  else if (frame instanceof TransferFrame) return this._processTransferFrame(frame);
  else if (frame instanceof frames.DispositionFrame) return this._handleDisposition(frame);
