var debug       = require('debug')('amqp10-disposition_frame'),
    util        = require('util'),
 ...
 * @constructor
 */
var DispositionFrame = function() {

};

DispositionFrame.prototype.outgoing = function() {
    this._buildOutgoing({ channel: 0x0, frameType: constants.frame_type.amqp });
};

util.inherits(DispositionFrame, Frame);