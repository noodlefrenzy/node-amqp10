 ...
 * @constructor
 */
var BeginFrame = function(options) {
    ...
    if (options instanceof DescribedType) {
        ...
        this.remoteChannel = null; // Since we're assuming we're the client, we start the sessions (and thus remote channel *MUST NOT* be set).
        ...
        this.handleMax = options.handleMax || constants.default_handle_max;
        this.offeredCapabilities = options.offeredCapabilities;
...
BeginFrame.Descriptor = new Int64(0x00000000, 0x00000011);

BeginFrame.prototype._getPerformative = function() {
    var self = this;
    return new DescribedType(BeginFrame.Descriptor, {
