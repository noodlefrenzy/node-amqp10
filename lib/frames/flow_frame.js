...
function FlowFrame(options) {
    ...
    if (options instanceof DescribedType) {
        ...
        this.nextIncomingId = options.name;
        this.incomingWindow = options.handle;
        this.nextOutgoingId = options.role;
...
FlowFrame.prototype._getPerformative = function() {
    ...
    return new DescribedType(FlowFrame.Descriptor.code, {
        nextIncomingId: new ForcedType('uint', self.nextIncomingId || null),
        ...
        handle: new ForcedType('uint', self.handle || null),
        deliveryCount: new ForcedType('uint', self.deliveryCount || null),
        linkCredit: new ForcedType('uint', self.linkCredit || null),
        available: new ForcedType('uint', self.available || null),
        drain: self.drain,
        echo: self.echo,
