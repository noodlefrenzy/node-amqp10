...
function FlowFrame(options) {
    ...
    if (options instanceof DescribedType) {
        ...
        this.nextIncomingId = options.nextIncomingId === undefined ? null : options.nextIncomingId;
        ...
        this.deliveryCount = options.deliveryCount;
        this.linkCredit = options.linkCredit;
...
FlowFrame.prototype._getPerformative = function() {
    ...
    return new DescribedType(FlowFrame.Descriptor.code, {
        nextIncomingId: new ForcedType('uint', self.nextIncomingId === undefined ? null : self.nextIncomingId),
        ...
        handle: new ForcedType('uint', self.handle === undefined ? null : self.handle),
        deliveryCount: new ForcedType('uint', self.deliveryCount === undefined ? null : self.deliveryCount),
        linkCredit: new ForcedType('uint', self.linkCredit === undefined ? null : self.linkCredit),
        available: new ForcedType('uint', self.available === undefined ? null : self.available),
        drain: self.drain,
        echo: self.echo,
...
FlowFrame.prototype.readPerformative = function(describedType) {
    ...
    var idx = 0;
    this.nextIncomingId = input[idx++] || null;
    this.incomingWindow = input[idx++];
    this.nextOutgoingId = input[idx++];
    this.outgoingWindow = input[idx++];
    this.handle = input[idx++] || null;
    this.deliveryCount = input[idx++] || null;
    this.linkCredit = input[idx++] || null;
    this.available = input[idx++] || null;
    this.drain = input[idx++] || false;
    this.echo = input[idx++] || false;
