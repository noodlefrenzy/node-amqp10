...
var debug = require('debug')('amqp10:framing:sasl'),
    util = require('util'),
...
SaslMechanisms.prototype.Descriptor = {
  name: new AMQPSymbol('amqp:sasl-mechanisms:list'),
...
SaslInit.prototype.Descriptor = {
  name: new AMQPSymbol('amqp:sasl-init:list'),
...
SaslChallenge.prototype.Descriptor = {
  name: new AMQPSymbol('amqp:sasl-challenge:list'),
...
SaslResponse.prototype.Descriptor = {
  name: new AMQPSymbol('amqp:sasl-response:list'),
...
SaslOutcome.prototype.Descriptor = {
  name: new AMQPSymbol('amqp:sasl-outcome:list'),
