...
SaslMechanisms.prototype.Descriptor = { code: 0x40, name: new AMQPSymbol('amqp:sasl-mechanisms:list') };
SaslMechanisms.prototype._writePayload = function(bufBuilder, options) {
  ...
  var data = new DescribedType(SaslMechanisms);
  if (this.mechanisms.length === 1) {
    data.value = [new AMQPSymbol(this.mechanisms[0])];
  } else {
...
SaslInit.prototype.Descriptor = { code: 0x41, name: new AMQPSymbol('amqp:sasl-init:list') };
SaslInit.prototype._writePayload = function(bufBuilder, options) {
  var data = new DescribedType(SaslInit);
  data.value = [
    this.mechanism,
...
SaslChallenge.prototype.Descriptor = { code: 0x42, name: new AMQPSymbol('amqp:sasl-challenge:list') };
SaslChallenge.prototype._writePayload = function(bufBuilder, options) {
  var data = new DescribedType(SaslChallenge);
  data.value = [
    this.challenge
  ];
  codec.encode(data, bufBuilder);
...
SaslResponse.prototype.Descriptor = { code: 0x43, name: new AMQPSymbol('amqp:sasl-response:list') };
SaslResponse.prototype._writePayload = function(bufBuilder, options) {
  var data = new DescribedType(SaslResponse);
  data.value = [
    this.response
  ];
  codec.encode(data, bufBuilder);
...
SaslOutcome.prototype.Descriptor = { code: 0x44, name: new AMQPSymbol('amqp:sasl-outcome:list') };
SaslOutcome.prototype._writePayload = function(bufBuilder, options) {
  var data = new DescribedType(SaslOutcome);
  data.value = [
