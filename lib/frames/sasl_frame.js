...
function SaslInit(options) {
  ...
  if (options instanceof DescribedType) {
    ...
    errors.assertArguments(options, ['mechanism']);
...
function SaslChallenge(options) {
  ...
  if (options instanceof DescribedType) {
    ...
    errors.assertArguments(options, ['challenge']);
...
function SaslResponse(options) {
  ...
  if (options instanceof DescribedType) {
    ...
    errors.assertArguments(options, ['response']);
...
function SaslOutcome(options) {
  ...
  if (options instanceof DescribedType) {
    ...
    errors.assertArguments(options, ['code']);
