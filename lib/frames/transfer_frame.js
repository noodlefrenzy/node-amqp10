...
TransferFrame.prototype._getPerformative = function() {
    ...
    return new DescribedType(TransferFrame.Descriptor.code, {
        ...
        deliveryId: new ForcedType('uint', self.deliveryId || null),
        deliveryTag: self.deliveryTag || null,
        messageFormat: new ForcedType('uint', self.messageFormat || null),
        settled: self.settled || null,
        more: self.more || false,
        receiverSettleMode: new ForcedType('ubyte', self.receiverSettleMode || null),
        state: self.state,
...
TransferFrame.prototype.readPerformative = function(describedType) {
    ...
    this.deliveryId = input[idx++] || null;
