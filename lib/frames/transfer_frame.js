...
TransferFrame.prototype._getPerformative = function() {
    ...
    return new DescribedType(TransferFrame.Descriptor.code, {
        ...
        deliveryId: new ForcedType('uint', self.deliveryId === undefined ? null : self.deliveryId),
        deliveryTag: self.deliveryTag || null,
        messageFormat: new ForcedType('uint', self.messageFormat === undefined ? null : self.messageFormat),
        settled: self.settled === undefined ? null : self.settled,
        more: self.more || false,
        receiverSettleMode: new ForcedType('ubyte', self.receiverSettleMode === undefined ? null : self.receiverSettleMode),
        state: self.state || null,
        resume: self.resume || false,
        aborted: self.aborted || false,
        batchable: self.batchable || false,
