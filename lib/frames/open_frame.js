...
OpenFrame.prototype._getPerformative = function() {
    ...
    return new DescribedType(OpenFrame.Descriptor.code, {
        ...
        maxFrameSize: new ForcedType('uint', self.maxFrameSize),
        channelMax: new ForcedType('ushort', self.channelMax),
        idleTimeout: new ForcedType('uint', self.idleTimeout),
        outgoingLocales: self.outgoingLocales,
        incomingLocales: self.incomingLocales,
