 ...
 * @constructor
 */
var OpenFrame = function(options) {
    ...
    if (options instanceof DescribedType) {
        ...
        this.id = options.container_id;
        this.hostname = options.hostname;
        this.max_frame_size = options.max_frame_size || constants.default_max_frame_size;
        this.channel_max = options.channel_max || constants.default_channel_max;
        this.idle_time_out = options.idle_time_out || constants.default_idle_time_out_in_ms;
        this.outgoing_locales = options.outgoing_locales || constants.default_outgoing_locales;
        this.incoming_locales = options.incoming_locales || constants.default_incoming_locales;
        this.offered_capabilities = options.offered_capabilities || null;
        this.desired_capabilities = options.desired_capabilities || null;
...
OpenFrame.prototype._getPerformative = function() {
    ...
    return new DescribedType(OpenFrame.Descriptor, {
        ...
        idle_time_out: new ForcedType('uint', self.idle_time_out), /* milliseconds */
        outgoing_locales: self.outgoing_locales, /* ietf-language-tag (symbol) */
        incoming_locales: self.incoming_locales, /* ietf-language-tag (symbol) */
        offered_capabilities: self.offered_capabilities, /* symbol */
        desired_capabilities: self.desired_capabilities, /* symbol */
