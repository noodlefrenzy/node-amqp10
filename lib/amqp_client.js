...
var EventEmitter = require('events').EventEmitter,
    ...
    NetTransport = require('./transport/net-transport.js'),
    TlsTransport = require('./transport/tls-transport.js'),
    Sasl = require('./sasl'),
...
function AMQPClient(policy) {
  ...
  this._transports = {};
  var tls = new TlsTransport();
  var net = new NetTransport();
  tls.register(this);
  net.register(this);
...
/**
 * Registers a protocol and its associated transport object.
 * 
 * @method registerProtocolHandler
 * @param {String} protocol   The protocol to be used when communicating with the server.
 * @param {Object} transport  The transport object which must be an implementation of AbstractTransport.
 */ 
AMQPClient.prototype.registerProtocolHandler = function (protocol, transport) {
...
AMQPClient.prototype._newConnection = function() {
  var self = this;
  var connection = new Connection(this.policy.connect, this._transports);
