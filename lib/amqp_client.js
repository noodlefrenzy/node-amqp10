...
/**
 * Map of various pre-defined policies (including DefaultPolicy), as well as a merge function allowing you
 * to create your own.
 */
AMQPClient.policies = {
  ...
  merge: function(newPolicy, base) { return u.deepMerge(newPolicy, base || DefaultPolicy); },
  utils: putils
};
