 ...
 * @param {Function} transportFactory  A factory method that instantiates a new transport object, which must be an implementation of AbstractTransport.
 */ 
AMQPClient.prototype.registerProtocolHandler = function (protocol, transportFactory) {
  TransportProvider.registerTransport(protocol, transportFactory);
};
