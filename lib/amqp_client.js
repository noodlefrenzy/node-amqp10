...
function AMQPClient(policy) {
  ...
  this._session = null;
  this._transportProvider = new TransportProvider();
...
AMQPClient.prototype.registerProtocolHandler = function (protocol, transport) {
  this._transportProvider.registerTransport(protocol, transport);
};
...
AMQPClient.prototype._newConnection = function() {
  var self = this;
  var connection = new Connection(this.policy.connect, this._transportProvider);
