...
var debug = require('debug')('amqp10:types:known'),
...
function convertType(describedType) {
  ...
  for (var idx in knownTypes) {
    ...
    if (curType.prototype.Descriptor.name.toString() === descriptorStr ||
        curType.prototype.Descriptor.code.toString() === descriptorStr) {
