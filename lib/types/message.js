...
Header.prototype.Descriptor = { code: 0x70, name: new AMQPSymbol('amqp:header:list') };
...
DeliveryAnnotations.prototype.Descriptor =
  { code: 0x71, name: new AMQPSymbol('amqp:delivery-annotations:map') };
...
Annotations.prototype.Descriptor = { code: 0x72, name: new AMQPSymbol('amqp:message-annotations:map') };
...
Properties.prototype.Descriptor = { code: 0x73, name: new AMQPSymbol('amqp:properties:list') };
...
ApplicationProperties.prototype.Descriptor = { code: 0x74, name: new AMQPSymbol('amqp:application-properties:map') };
...
Footer.prototype.Descriptor = { code: 0x78, name: new AMQPSymbol('amqp:footer:map') };
...
Data.prototype.Descriptor = { code: 0x75, name: new AMQPSymbol('amqp:data:binary') };
...
AMQPSequence.prototype.Descriptor = { code: 0x76, name: new AMQPSymbol('amqp:amqp-sequence:list') };
...
AMQPValue.prototype.Descriptor = { code: 0x77, name: new AMQPSymbol('amqp:amqp-value:*') };
