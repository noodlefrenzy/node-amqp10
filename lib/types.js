...
function compositeAccessors(index, field) {
  return {
    ...
    get: function() { return this.value[index]; },
    set: function(value) { this.value[index] = wrapField(field, value); }
  };
}

types.defineComposite = function(Base, definition) {
  ...
  var Composite = function(fields) {
    Composite.super_.call(this, fields);
    if (fields instanceof DescribedType) {
      this.value = fields.value ? fields.value : [];
      return;
    }
