...
var types = [
    ...
    },
    {
        ...
        "encoder": function(val, buf, offset, codec) {
            if (typeof val === 'object') {

            } else {
                throw exceptions.NotImplementedError('Unsure how to encode non-object as list');
            }
        },
        "encodings": [
            {
...
for (var idx in types) {
    ...
    encoders[curType.name] = curType.encoder;
