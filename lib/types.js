...
function registerType(name, options) {
  ...
  if (!!options.builder) {
    types[name].encode = options.builder;
  } else {
  ...
  options.encodings.forEach(function(encoding) {
    ...
    types[encoding.code].encode = encoding.builder;
  });
}
...
registerType('decimal32', {
  encodings: [{
    code: 0x74,
    builder: function(val, bufb) { throw new errors.NotImplementedError('Decimal32'); },
    decoder: function(buf) { throw new errors.NotImplementedError('Decimal32'); }
  }]
});

registerType('decimal64', {
  encodings: [{
    code: 0x84,
    builder: function(val, bufb) { throw new errors.NotImplementedError('Decimal64'); },
    decoder: function(buf) { throw new errors.NotImplementedError('Decimal64'); }
  }]
});

registerType('decimal128', {
  encodings: [{
    code: 0x94,
    builder: function(val, bufb) { throw new errors.NotImplementedError('Decimal128'); },
    decoder: function(buf) { throw new errors.NotImplementedError('Decimal128'); }
  }]
});
...
registerType('uuid', {
  encodings: [{
    code: 0x98,
    builder: function(val, bufb) { bufb.appendBuffer(new Buffer(uuid.parse(val))); },
...
registerType('list', {
  ...
  encodings: [{
    ...
    code: 0xc0,
    builder: function(val, bufb, codec) { listBuilder(val, bufb, codec, 1); },
    decoder: function(buf, codec) { return listDecoder(1, buf, codec); }
  }, {
    code: 0xd0,
    builder: function(val, bufb, codec) { listBuilder(val, bufb, codec, 4); },
...
registerType('map', {
  ...
  encodings: [{
    code: 0xc1,
    builder: function(val, bufb, codec) { mapBuilder(val, bufb, codec, 1); },
    decoder: function(buf, codec) { return mapDecoder(1, buf, codec); }
  },
  {
    code: 0xd1,
    builder: function(val, bufb, codec) { mapBuilder(val, bufb, codec, 4); },
...
registerType('array', {
  ...
  encodings: [{
    code: 0xe0,
    builder: function(val, bufb, codec) { arrayBuilder(val, bufb, codec, 1); },
    decoder: function(buf, codec) { return arrayDecoder(1, buf, codec); }
  },
  {
    code: 0xf0,
    builder: function(val, bufb, codec) { arrayBuilder(val, bufb, codec, 4); },
