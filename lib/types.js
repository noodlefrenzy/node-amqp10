...
var uuid = {
  ...
  unparse: function unparse(buf, offset) {
...
registerType('symbol', {
  encoder: function(val, bufb) {
    var encoded = new Buffer(val, 'ascii');
...
types.defineComposite = require('./types/composite_type').defineComposite;
