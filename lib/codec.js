  ...
  switch (type) {
    ...
    case 'object':
      if (val instanceof Buffer) {
        ...
        var asList = []; // LINQify
        val.encodeOrdering.forEach(function (field) {
          if (val[field] === undefined) throw new errors.EncodingError('Encoding map as list failed, encodeOrdering[' + field + '] field not found or set as undefined in map ' + JSON.stringify(val));
